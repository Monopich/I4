...
var _hoisted_14 = ["id"];
var _hoisted_24 = ["id", "placeholder", "aria-expanded", "aria-controls", "aria-labelledby", "aria-label", "aria-invalid", "disabled", "readonly"];
...
function render4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _objectSpread(_objectSpread({}, _ctx.inputProps), _ctx.ptm("input"))), null, 16, _hoisted_24)) : createCommentVNode("", true), _ctx.showIcon && _ctx.iconDisplay === "button" ? (openBlock(), createBlock(_component_CalendarButton, {
    key: 1,
