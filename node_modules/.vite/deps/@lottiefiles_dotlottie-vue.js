...
var Rn = (() => {
  var _a;
  var g = typeof document < "u" ? (_a = document.currentScript) == null ? void 0 : _a.src : void 0;
  return function(n = {}) {
    var a = n, h2, w, x = new Promise((e, t) => {
      h2 = e, w = t;
    ...
    function _e(e) {
      var _a2;
      throw (_a2 = a.onAbort) == null ? void 0 : _a2.call(a, e), e = "Aborted(" + e + ")", Z(e), nt = true, e = new WebAssembly.RuntimeError(e + ". Build with -sASSERTIONS for more info."), w(e), e;
    }
...
`, "%p": (l) => 0 <= l.Ra && 12 > l.Ra ? "AM" : "PM", "%S": (l) => s(l.sb, 2), "%t": () => "	", "%u": (l) => l.Ga || 7, "%U": (l) => s(Math.floor((l.Ia + 7 - l.Ga) / 7), 2), "%V": (l) => {
    ...
    gt = Tt, _ = a.BindingError = class extends Error {
      ...
      var _a2;
      (_a2 = this.Fa) == null ? void 0 : _a2.call(this, e);
...
` + i.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    var bn = { c: (e, t, r, i) => {
      ...
      function e(r) {
        var _a3;
        return F = r.exports, ge = F.da, it(), k = F.ha, st.unshift(F.ea), J--, (_a3 = a.monitorRunDependencies) == null ? void 0 : _a3.call(a, J), J == 0 && (oe && (r = oe, oe = null, r())), F;
      }
      var t = { a: bn };
      if (J++, (_a2 = a.monitorRunDependencies) == null ? void 0 : _a2.call(a, J), a.instantiateWasm)
        try {
    ...
    function Dt() {
      function e() {
        if (!Ie && (Ie = true, a.calledRun = true, !nt)) {
          if (xe(st), h2(a), a.onRuntimeInitialized && a.onRuntimeInitialized(), a.postRun)
  ...
  static async _loadWithBackup() {
    return this._ModulePromise || (this._ModulePromise = this._tryLoad(this._wasmURL).catch(async (n) => {
      ...
      try {
        ...
        throw console.error(`Primary WASM URL failed: ${n.message}`), console.error(`Backup WASM URL failed: ${h2.message}`), new Error("WASM loading failed from all sources.");
      }
    })), this._ModulePromise;
  }
  static async load() {
...
var re = class {
  ...
  addEventListener(n, a) {
    let h2 = this._eventListeners.get(n);
    h2 || (h2 = /* @__PURE__ */ new Set(), this._eventListeners.set(n, h2)), h2.add(a);
  }
  removeEventListener(n, a) {
    let h2 = this._eventListeners.get(n);
    h2 && (a ? (h2.delete(a), h2.size === 0 && this._eventListeners.delete(n)) : this._eventListeners.delete(n));
  }
  dispatch(n) {
    var _a;
    (_a = this._eventListeners.get(n.type)) == null ? void 0 : _a.forEach((h2) => h2(n));
  }
...
var L = class L2 {
  ...
  _loadFromSrc(n) {
    async function a() {
      let h2 = await fetch(n);
      if (!h2.ok)
        throw new Error(`Failed to fetch the animation data from URL: ${n}. ${h2.status}: ${h2.statusText}`);
      let w = (h2.headers.get("content-type") ?? "").trim(), x;
      return ["application/json", "text/plain"].some((j) => w.startsWith(j)) ? x = await h2.text() : x = await h2.arrayBuffer(), x;
    }
    a().then((h2) => {
      this._loadFromData(h2);
    }).catch((h2) => {
      this._eventManager.dispatch({ type: "loadError", error: new Error(`Failed to load animation data from URL: ${n}. ${h2}`) });
    });
  }
  _loadFromData(n) {
    if (this._dotLottieCore === null)
      return;
    let a = this._canvas.width, h2 = this._canvas.height, w = false;
    if (typeof n == "string")
      w = this._dotLottieCore.loadAnimationData(n, a, h2);
    else if (n instanceof ArrayBuffer)
      w = this._dotLottieCore.loadDotLottieData(n, a, h2);
    else if (typeof n == "object")
      w = this._dotLottieCore.loadAnimationData(JSON.stringify(n), a, h2);
    else {
  ...
  get layout() {
    var _a;
    let n = (_a = this._dotLottieCore) == null ? void 0 : _a.config().layout;
    if (n)
      return { align: [n.align.get(0), n.align.get(1)], fit: (() => {
        var _a2, _b, _c, _d, _e, _f;
        switch (n.fit) {
          case ((_a2 = L2._wasmModule) == null ? void 0 : _a2.Fit.Contain):
            return "contain";
          case ((_b = L2._wasmModule) == null ? void 0 : _b.Fit.Cover):
            return "cover";
          case ((_c = L2._wasmModule) == null ? void 0 : _c.Fit.Fill):
            return "fill";
          case ((_d = L2._wasmModule) == null ? void 0 : _d.Fit.FitHeight):
            return "fit-height";
          case ((_e = L2._wasmModule) == null ? void 0 : _e.Fit.FitWidth):
            return "fit-width";
          case ((_f = L2._wasmModule) == null ? void 0 : _f.Fit.None):
            return "none";
          default:
            return "contain";
        }
  ...
  get manifest() {
    var _a;
    try {
      let n = (_a = this._dotLottieCore) == null ? void 0 : _a.manifestString();
  ...
  get segment() {
    var _a;
    let n = (_a = this._dotLottieCore) == null ? void 0 : _a.config().segment;
    if (n && n.size() === 2)
  ...
  get mode() {
    var _a, _b, _c, _d;
    let n = (_a = this._dotLottieCore) == null ? void 0 : _a.config().mode;
    return n === ((_b = L2._wasmModule) == null ? void 0 : _b.Mode.Reverse) ? "reverse" : n === ((_c = L2._wasmModule) == null ? void 0 : _c.Mode.Bounce) ? "bounce" : n === ((_d = L2._wasmModule) == null ? void 0 : _d.Mode.ReverseBounce) ? "reverse-bounce" : "forward";
  }
  get isFrozen() {
  ...
  _render() {
    ...
    if (this._dotLottieCore.render()) {
      let a = this._dotLottieCore.buffer(), h2 = new Uint8ClampedArray(a, 0, this._canvas.width * this._canvas.height * 4), w = null;
      return typeof ImageData > "u" ? (w = this._context.createImageData(this._canvas.width, this._canvas.height), w.data.set(h2)) : w = new ImageData(h2, this._canvas.width, this._canvas.height), this._context.putImageData(w, 0, 0), this._eventManager.dispatch({ type: "render", currentFrame: this._dotLottieCore.currentFrame() }), true;
    }
    return false;
  }
  _draw() {
  ...
  resize() {
    ...
    if (V && this._canvas instanceof HTMLCanvasElement) {
      let a = this._renderConfig.devicePixelRatio || window.devicePixelRatio || 1, { height: h2, width: w } = this._canvas.getBoundingClientRect();
      this._canvas.width = w * a, this._canvas.height = h2 * a;
    }
  ...
  markers() {
    var _a;
    let n = (_a = this._dotLottieCore) == null ? void 0 : _a.markers();
    if (n) {
      let a = [];
      for (let h2 = 0; h2 < n.size(); h2 += 1) {
        let w = n.get(h2);
  ...
  setViewport(n, a, h2, w) {
    return this._dotLottieCore === null ? false : this._dotLottieCore.setViewport(n, a, h2, w);
  }
  static setWasmUrl(n) {
    X.setWasmUrl(n);
  }
  loadStateMachine(n) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.loadStateMachine(n)) ?? false;
  }
  startStateMachine() {
    var _a;
    let n = ((_a = this._dotLottieCore) == null ? void 0 : _a.startStateMachine()) ?? false;
    return n && this._setupStateMachineListeners(), n;
  }
  stopStateMachine() {
    var _a;
    let n = ((_a = this._dotLottieCore) == null ? void 0 : _a.stopStateMachine()) ?? false;
    return n && this._cleanupStateMachineListeners(), n;
  }
  _getPointerPosition(n) {
    let a = this._canvas.getBoundingClientRect(), h2 = this._canvas.width / a.width, w = this._canvas.height / a.height, x = this._renderConfig.devicePixelRatio || window.devicePixelRatio || 1, j = (n.clientX - a.left) * h2 / x, U = (n.clientY - a.top) * w / x;
    return { x: j, y: U };
  }
  _onPointerUp(n) {
    let { x: a, y: h2 } = this._getPointerPosition(n);
    this.postStateMachineEvent(`OnPointerUp: ${a} ${h2}`);
  }
  _onPointerDown(n) {
    let { x: a, y: h2 } = this._getPointerPosition(n);
    this.postStateMachineEvent(`OnPointerDown: ${a} ${h2}`);
  }
  _onPointerMove(n) {
    let { x: a, y: h2 } = this._getPointerPosition(n);
    this.postStateMachineEvent(`OnPointerMove: ${a} ${h2}`);
  }
  _onPointerEnter(n) {
    let { x: a, y: h2 } = this._getPointerPosition(n);
    this.postStateMachineEvent(`OnPointerEnter: ${a} ${h2}`);
  }
  _onPointerLeave(n) {
    let { x: a, y: h2 } = this._getPointerPosition(n);
    this.postStateMachineEvent(`OnPointerExit: ${a} ${h2}`);
  }
  _onComplete() {
  ...
  postStateMachineEvent(n) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.postEventPayload(n)) ?? false;
  }
  ...
  loadStateMachineData(n) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.loadStateMachineData(n)) ?? false;
  }
  animationSize() {
    var _a, _b;
    let n = ((_a = this._dotLottieCore) == null ? void 0 : _a.animationSize().get(0)) ?? 0, a = ((_b = this._dotLottieCore) == null ? void 0 : _b.animationSize().get(1)) ?? 0;
    return { width: n, height: a };
  }
  setStateMachineBooleanContext(n, a) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.setStateMachineBooleanContext(n, a)) ?? false;
  }
  setStateMachineNumericContext(n, a) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.setStateMachineNumericContext(n, a)) ?? false;
  }
  setStateMachineStringContext(n, a) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.setStateMachineStringContext(n, a)) ?? false;
  }
};
...
var Se = class {
  ...
  sendMessage(n, a, h2) {
    this.getWorker(n).postMessage(a, h2 || []);
  }
  terminateWorker(n) {
...
var z = class z2 {
  ...
  async _create(n) {
    ...
    let { instanceId: h2 } = await this._sendMessage("create", { instanceId: this._id, config: { ...n, canvas: a }, ...Ut(this._canvas) }, [a]);
    if (h2 !== this._id)
  ...
  async setViewport(n, a, h2, w) {
    return this._created ? this._sendMessage("setViewport", { x: n, y: a, width: h2, height: w, instanceId: this._id }) : false;
  }
  async _sendMessage(n, a, h2) {
    let w = { id: `dotlottie-request-${Bt()}`, method: n, params: a };
    return this._worker.postMessage(w, h2 || []), new Promise((x, j) => {
      let U = ($) => {
        let Q = $.data;
  ...
  _getPointerPosition(n) {
    let a = this._canvas.getBoundingClientRect(), h2 = this._canvas.width / a.width, w = this._canvas.height / a.height, x = this._dotLottieInstanceState.renderConfig.devicePixelRatio || window.devicePixelRatio || 1, j = (n.clientX - a.left) * h2 / x, U = (n.clientY - a.top) * w / x;
    return { x: j, y: U };
  }
  _onPointerUp(n) {
    let { x: a, y: h2 } = this._getPointerPosition(n);
  ...
  setup(props, { attrs, expose }) {
    ...
    function updateViewport() {
      ...
      if (!canvas.value || !dotLottie)
        return;
      const dpr = ((_a = props.renderConfig) == null ? void 0 : _a.devicePixelRatio) || window.devicePixelRatio || 1;
        ...
        (entries) => {
          entries.forEach((entry) => {
            if (entry.isIntersecting) {
              dotLottie == null ? void 0 : dotLottie.unfreeze();
            } else {
              dotLottie == null ? void 0 : dotLottie.freeze();
            }
          });
        },
        {
    ...
    function getResizeObserver() {
      return new ResizeObserver((entries) => {
        entries.forEach(() => {
          dotLottie == null ? void 0 : dotLottie.resize();
        });
      });
    }
    onMounted(() => {
      ...
      if (typeof (autoResizeCanvas == null ? void 0 : autoResizeCanvas.value) === "boolean" && autoResizeCanvas.value) {
    ...
    onBeforeUnmount(() => {
      ...
      (_a = canvas.value) == null ? void 0 : _a.addEventListener("mouseenter", hoverHandler);
      (_b = canvas.value) == null ? void 0 : _b.addEventListener("mouseleave", hoverHandler);
      dotLottie == null ? void 0 : dotLottie.removeEventListener("frame", updateViewport);
