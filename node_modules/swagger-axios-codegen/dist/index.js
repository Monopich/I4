...
function codegen(params) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (params.remoteUrl) {
                const { data: swaggerJson } = yield (0, axios_1.default)({ url: params.remoteUrl, responseType: 'text', httpsAgent: new https.Agent({ rejectUnauthorized: false }) });
            ...
            console.log('loaded spec document fail!', (_a = params.remoteUrl) !== null && _a !== void 0 ? _a : params.source, ', Error: ' + error.message);
            return;
        }
