 ...
 * @param s
 */
function refClassName(s, format) {
...
function validRefTypeName(str) {
    return reg.test(str);
}
exports.validRefTypeName = validRefTypeName;
