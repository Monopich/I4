...
function getRequestParameters(params, useHeaderParameters) {
    ...
    params.forEach(p => {
        ...
        if (p.schema) {
            ...
            propType = p.items.$ref ? (0, utils_1.refClassName)(p.items.$ref) + '[]' : (0, utils_1.toBaseType)(p.items.type, (_a = p.items) === null || _a === void 0 ? void 0 : _a.format) + '[]';
            imports.push(propType);
        }
        // 基本类型
        else {
            propType = (0, utils_1.toBaseType)(p.type, p === null || p === void 0 ? void 0 : p.format);
        }
